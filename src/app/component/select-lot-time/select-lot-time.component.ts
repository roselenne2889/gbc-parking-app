...
export class SelectLotTimeComponent implements OnInit {
  ...
  submitSelectLotForm() {
    if (this.selectLotForm.valid) {
      ...
      this.reservation.start_time = this.selectLotForm.get("start_time").value;
      this.reservation.end_time = this.selectLotForm.get("end_time").value;
      this.reservation.lot.lot_id = this.selectLotForm.get("lot_id").value;
